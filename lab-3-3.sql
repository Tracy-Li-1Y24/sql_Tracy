...
-- when a column exist in select with the aggregate function, it has to appear in group by a the same time
-- so in this case "SELECT year, name, max(wins) FROM teams" is not accurate
